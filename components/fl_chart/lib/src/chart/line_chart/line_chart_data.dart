...
class LineChartData extends AxisChartData with EquatableMixin {
  ...
  LineChartData({
    ...
    minX:
    minX ?? LineChartHelper
        .calculateMaxAxisValues(lineBarsData)
        .minX,
    maxX:
    maxX ?? LineChartHelper
        .calculateMaxAxisValues(lineBarsData)
        .maxX,
    minY:
    minY ?? LineChartHelper
        .calculateMaxAxisValues(lineBarsData)
        .minY,
    maxY:
    maxY ?? LineChartHelper
        .calculateMaxAxisValues(lineBarsData)
        .maxY,
  );
...
class LineChartBarData with EquatableMixin {
  ...
  static LineChartBarData lerp(LineChartBarData a,
      LineChartBarData b,
      double t,) {
...
class LineChartStepData with EquatableMixin {
  ...
  static LineChartStepData lerp(LineChartStepData a,
      LineChartStepData b,
      double t,) {
...
class BarAreaSpotsLine with EquatableMixin {
  ...
  static BarAreaSpotsLine lerp(BarAreaSpotsLine a,
      BarAreaSpotsLine b,
      double t,) {
...
Color _defaultGetDotStrokeColor(FlSpot spot,
    double xPercentage,
...
List<TouchedSpotIndicatorData> defaultTouchedIndicators(LineChartBarData barData,
    List<int> indicators,) {
...
class LineTooltipItem with EquatableMixin {
  ...
  const LineTooltipItem(this.text,
      this.textStyle, {
...
class TouchedSpotIndicatorData with EquatableMixin {
  ...
  const TouchedSpotIndicatorData(this.indicatorBelowLine,
