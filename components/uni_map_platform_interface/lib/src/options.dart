...
class PolylineOption {
  ...
  @override
  String toString() {
    return 'PolylineOption{latLngList: $coordinateList, width: $width, strokeColor: $strokeColor, '
        'textureProvider: $textureProvider, lineCapType: $lineCapType, lineJoinType: $lineJoinType, '
        'dashType: $dashType, useGradient: $useGradient, colorList: $colorList}';
  }
}
