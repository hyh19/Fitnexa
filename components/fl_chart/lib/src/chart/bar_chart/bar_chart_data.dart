  ...
  BarChartData({
    ...
    ExtraLinesData? extraLinesData,
      ...
      : barGroups = barGroups ?? const [],
        ...
        minX: 0,
        maxX: 1,
        maxY: maxY ?? BarChartHelper
            .calculateMaxAxisValues(barGroups ?? [])
            .maxY,
        minY: minY ?? BarChartHelper
            .calculateMaxAxisValues(barGroups ?? [])
            .minY,
      );
...
class BarChartGroupData with EquatableMixin {
  ...
  static BarChartGroupData lerp(BarChartGroupData a,
      BarChartGroupData b,
      double t,) {
    return BarChartGroupData(
...
class BarChartRodStackItem with EquatableMixin {
  ...
  /// )
  /// ```
  BarChartRodStackItem(this.fromY,
      this.toY,
      this.color, [
  ...
  static BarChartRodStackItem lerp(BarChartRodStackItem a,
...
class BackgroundBarChartRodData with EquatableMixin {
  ...
  static BackgroundBarChartRodData lerp(BackgroundBarChartRodData a,
...
class BarTouchTooltipData with EquatableMixin {
  ...
  BarTouchTooltipData({
    ...
    FlLine? touchLineIndicator,
      ...
      : tooltipBgColor = tooltipBgColor ?? Colors.blueGrey.darken(15),
        ...
        horizontalFixed = horizontalFixed ?? false,
        touchLineIndicator = touchLineIndicator ?? FlLine(strokeWidth: 1, color: Colors.white24),
        super();
  ...
  /// Tooltip 水平方向是否固定
  final bool horizontalFixed;

  /// 触摸指示线
  final FlLine touchLineIndicator;
...
BarTooltipItem? defaultBarTooltipItem(BarChartGroupData group,
    int groupIndex,
    BarChartRodData rod,
    int rodIndex,) {
...
class BarTouchedSpot extends TouchedSpot with EquatableMixin {
  ...
  BarTouchedSpot(this.touchedBarGroup,
      ...
      FlSpot spot,
      Offset offset,) : super(spot, offset);
