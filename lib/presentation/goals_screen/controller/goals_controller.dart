...
/// A controller class for the GoalsScreen.
///
/// This class manages the state of the GoalsScreen, including the
/// current goalsModelObj
class GoalsController extends GetxController {
  Rx<GoalsModel> goalsModelObj = GoalsModel().obs;
