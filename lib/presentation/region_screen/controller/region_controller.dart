...
/// A controller class for the RegionScreen.
///
/// This class manages the state of the RegionScreen, including the
/// current regionModelObj
class RegionController extends GetxController {
  TextEditingController countryController = TextEditingController();

  TextEditingController searchController = TextEditingController();

  Rx<RegionModel> regionModelObj = RegionModel().obs;
