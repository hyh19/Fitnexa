...
import '../models/pairing_success_model.dart';

/// A controller class for the PairingSuccessScreen.
///
/// This class manages the state of the PairingSuccessScreen, including the
/// current pairingSuccessModelObj
class PairingSuccessController extends GetxController {
  Rx<PairingSuccessModel> pairingSuccessModelObj = PairingSuccessModel().obs;
